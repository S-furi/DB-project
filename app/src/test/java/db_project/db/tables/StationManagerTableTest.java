...
public class StationManagerTableTest {
    ...
    private static final StationManagerTable stationManagerTable = new StationManagerTable(connectionProvider.getMySQLConnection());

    private final static Date date = new Date(12122001);
    private final StationManager stationManager = new StationManager("3", date, "Peppe", "Pesce", 3, "peppe@peppe.com", "A");
    ...
    static void setUp(){
        ...
        final StationManager stationManager1 = new StationManager("1", date1, "Mimmo", "Baresi", 3, "a@gmail.com", "CastelFranco");
        final StationManager stationManager2 = new StationManager("2", date2, "Franco", "Pino", 2, "franco@pino.com", "CastelFranco");
