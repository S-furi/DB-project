...
public class PathTableTest {
    ...
    private static final PathTable pathTable = 
        new PathTable(connectionProvider.getMySQLConnection());
    ...
    static void setUp() {
        ...
        final var path1 = 
            new Path("1", "01:11", 5, "1");
        final var path2 = 
            new Path("2", "02:21", 2, "2");
    ...
    public void testUpdateValue() {
        ...
        var newPath = new Path(
            "1", this.path.getTotalTime(), this.path.getStops(), this.path.getAdminID());
