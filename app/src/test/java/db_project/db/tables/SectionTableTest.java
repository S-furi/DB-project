...
public class SectionTableTest {
    ...
    private static final SectionTable sectionTable = new SectionTable(connectionProvider.getMySQLConnection());
    ...
    public void testUpdate() {
        ...
        final var newSection = new Section(this.section.getStartStation(), this.section.getEndStation(), "1",
