...
public class RouteInfoTableTest {
    ...
    private static final RouteInfoTable routeInfoTable = new RouteInfoTable(connectionProvider.getMySQLConnection());

    private final RouteInfo routeInfo = new RouteInfo("1", "1",
            Utils.dateToSqlDate(Utils.buildDate(22, 11, 2011).get()));
    ...
    public static void setUp() {
        ...
        final var routeInfo1 = new RouteInfo("1", "1", Utils.dateToSqlDate(Utils.buildDate(21, 11, 2011).get()));
        final var routeInfo2 = new RouteInfo("2", "1", Utils.dateToSqlDate(Utils.buildDate(11, 06, 2011).get()));
    ...
    public void testFindByPrimaryKey() {
        final List<Object> okKeys = List.of("1", "1", Utils.dateToSqlDate(Utils.buildDate(21, 11, 2011).get()));

        // changed date of one day
        final List<Object> failingKeys = List.of("1", "1", Utils.dateToSqlDate(Utils.buildDate(22, 11, 2011).get()));
    ...
    public void testSaveAndDelete() {
        ...
        assertTrue(routeInfoTable
                .delete(List.of(this.routeInfo.getPathId(), this.routeInfo.getTrainId(), this.routeInfo.getDate())));
        assertFalse(routeInfoTable
                .delete(List.of(this.routeInfo.getPathId(), this.routeInfo.getTrainId(), this.routeInfo.getDate())));
    }
}
