...
public class TicketDetailTableTest {
    ...
    public static void setUp() {
        ...
        final var ticketDetail1 = new TicketDetail("1", Utils.dateToSqlDate(Utils.buildDate(11, 11, 1911).get()), "1", "1", 1, 15);
        final var ticketDetail2 = new TicketDetail("2", Utils.dateToSqlDate(Utils.buildDate(12, 11, 1911).get()), "1", "1", 1, 15);
    ...
    public static void tearDown() {
        ticketDetailTable.findAll().forEach(t -> ticketDetailTable.delete(List.of(t.getTrainClass(), t.getTrainId(), t.getCarNumber(), t.getSeatNumber(), t.getTripDate())));
    ...
    public void testFindByPrimaryKey() {
        assertTrue(ticketDetailTable.findByPrimaryKey(List.of("1", "1", 1, 15, Utils.dateToSqlDate(Utils.buildDate(12, 11, 1911).get()))).isPresent());
        assertFalse(ticketDetailTable.findByPrimaryKey(List.of("1", "1", 1, 17, Utils.dateToSqlDate(Utils.buildDate(12, 11, 1911).get()))).isPresent());
    }
}
