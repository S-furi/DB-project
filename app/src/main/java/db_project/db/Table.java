...
/**
 * Represents a DB table, with rows represented by objects of type V
...
public interface Table<V, K> {
     ...
     * @param primaryKey
     * @return an empty {@link java.util.Optional} if there is no object
     * with the given ID in the DB.
     */
