...
public class QueryParser {
    ...
    public QueryParser(final Connection connection) {
    ...
    public QueryParser select(final String query, final Object args) {
        this.insertPortion("SELECT", query, args);
        return this;
    }

    public QueryParser from(final String query) {
        this.insertPortion("FROM", query, "");
        return this;
    }

    public QueryParser where(final String query, final Object args) {
        this.insertPortion("WHERE", query, args);
        return this;
    }

    public QueryParser and(final String query, final Object args) {
