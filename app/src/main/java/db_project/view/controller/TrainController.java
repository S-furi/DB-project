...
public class TrainController {
    ...
    private int getLastTrainId() {
        final var lastTrain = this.trainTable
            .findAll()
            .stream()
            .sorted((t1,t2) ->  //reversed sort
                Integer.compare(Integer.parseInt(t2.getLicenseNumber()), Integer.parseInt(t1.getLicenseNumber())))
            .findFirst();
    ...
    public ObservableList<Driver> getAllDrivers() {
        ...
        this.drivers.addAll(
            this.driverTable
                .findAll()
                .stream()
                .sorted((d1, d2) -> Integer.compare(Integer.parseInt(d1.getLicenceNumber()), Integer.parseInt(d2.getLicenceNumber())))
    ...
    public void refreshTrains() {
        this.trains.clear();
        this.trains.addAll(
            this.trainTable.findAll()
            .stream()
            .sorted((t1, t2) -> Integer.compare(Integer.parseInt(t1.getTrainCode()), Integer.parseInt(t2.getTrainCode())))
            .collect(Collectors.toList()));
    }
}
