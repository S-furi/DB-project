...
public class RoutePathFinder {
   ...
   */
  private static LinkedList<String> getOrderedPath(
      final Map<String, String> parent, final String arrive, final String actual) {
  ...
  private String getStationNameFromAlias(final int i) {
    return this.stationAliases.entrySet().stream()
