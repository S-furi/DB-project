...
public class StationsLoader {
  private static final String STATION_IDS_FILEPATH =
      "data_generation/railway/route_data/statID.json";
  private static final String STATION_DISTANCES_FILEPATH =
      "data_generation/railway/route_data/routes_distances_diff.json";
  ...
  /**
   * Get routes informations contained into Json in a java, easy-to-read, format.
   *
